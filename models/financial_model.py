        ...
        try:
            ...
            for month in months:
                try:
                    ...
                    monthly_transactions = 3.5  # среднее количество транзакций в месяц
                    purchase_volume = active_users * monthly_check * monthly_transactions
                    
                    # Commission calculations
                    loyalty_turnover = purchase_volume * st.session_state['cashback_rate']
                    cashback = loyalty_turnover
                    ...
                    expired_points_income = unclaimed_points * st.session_state['expired_points_rate']
                    ...
                    partner_revenue = (stores + restaurants) * 1000
                    ...
                    if month > 12:  # Second year
                        burn_rate_fot = st.session_state['burn_rate_fot_2']
                    elif month > 6:  # Months 7-12
                        burn_rate_fot = st.session_state['burn_rate_fot_1']
